...
public class Detailsbulletin {
   ...
   private String Discipline; 
    ...
    {
    	return this.fk_bulletin;
    }
    public void set_idbulletin(int id)
    {
     this.fk_bulletin=id;
    }
    
    public int get_numerorTimestre()
    {
    	return this.numero_trimestre;
    }
    public void set_numeroTrimestre(int num)
    {
     this.numero_trimestre=num;
    }
